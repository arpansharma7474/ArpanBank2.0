...
class UsersScreen extends React.PureComponent {
  ...
  getUpdatedUser = async () => {
    ...
    const res = await this.props.getUsersTransactions(
      this.user.id,
      this.props.page,
    );
        ...
        <ScrollView
          ...
          <View
            ...
            <Text
              ...
              Hello {this.user.name}, You have following amount pending :{' '}
            </Text>
            <Text
              style={[
                styles.money_text,
          ...
          <View
            ...
            {this.props.usersTransactions.length > 0 ? (
              <AppButton
                style={{
                  position: 'absolute',
                  marginVertical: 5,
          ...
          <FlatList
            ...
            renderItem={({item, index}) => (
              <TransactionsItem hideCustomer item={item} />
            )}
          />
        </ScrollView>
      </View>
